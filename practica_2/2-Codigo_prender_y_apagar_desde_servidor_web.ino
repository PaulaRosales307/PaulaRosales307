...
const char* ssid = "MEGACABLE-2.4G-A9AA";
const char* password = "DJ2ttAfj3m";
WiFiServer server(80);
//Se tiene un LED incorporado en terminal 2, se puede usar otro
#define LED 2
String estado = "";
void setup() {
Serial.begin(115200);
...
client.println("<h1>Paula Rosales</h1>");
client.println("<h2><font color='#33CEFF'>Webserver 1.0</font></h2>");client.println("<h3>Práctica boton</h3>");
